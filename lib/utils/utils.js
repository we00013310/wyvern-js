...
exports.utils = {
    ...
    getOrderHashHex: function (order) {
        console.log("test", order.basePrice, exports.utils.bigNumberToBN(order.basePrice), exports.utils.bigNumberToBN(order.basePrice).toString(), new utils_1.BigNumber(order.basePrice).toString());
        var orderParts = [
            ...
            {
                value: new utils_1.BigNumber(order.basePrice).toString(),
                type: types_1.SolidityTypes.Uint256,
            },
